...
class EventServiceTest {
    ...
    @Test
    void givenNothing_whenSearchingEvents_thenReturnsEntireEven() {
        // Given
    ...
    @DisplayName("이벤트 ID로 존쟇는 이벤트를 조회하면, 빈 정보를 출력하여 보여준다")
    @Test
    ...
    void givenNothing_whenCreating_thenAbortCreatingAndReturnsFalse() {
        ...
        // When
        boolean result = sut.creatEvent(null);
    ...
    void givenDataRelatedException_whenCreating_thenThrowsGeneralException() {
        ...
        // When
        Throwable thrown = catchThrowable(() -> sut.creatEvent(null));
    ...
    @Test
    void givenEventIdAndItsIndo_whenModifying_thenModifiesEventAndReturnsTrue() {
        // Given
        long eventId = 1L;
    ...
    @DisplayName("이벤트 ID를 주지 않으면, 이벤트 정보를 변경을 중단하고 결과를 false 로 보여준다")
    @Test
    ...
    @DisplayName("이벤트 ID만 주고 변경할 정보를 주지 않으면, 이벤트 정보를 변경을 중단하고 결과를 false 로 보여준다")
    @Test
    ...
    @Test
    void givenEventId_whenDeleting_thenDeletingAndReturnsTrue() {
        // Given
        long eventId = 1L;
    ...
    @DisplayName("이벤트 ID를 주지 않으면, 삭제중단하고 결과를 false로 보여준다")
    @Test
    ...
    private EventDTO createEventDTO(long placeId, String eventName, boolean isMoring) {
        String hourStart = isMoring ? "09" : "13";
        String hourEnd = isMoring ? "12" : "16";
